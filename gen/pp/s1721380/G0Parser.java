...
public class G0Parser extends Parser {
	...
	public static class CContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof G0Listener ) ((G0Listener)listener).enterC(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof G0Listener ) ((G0Listener)listener).exitC(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof G0Visitor ) return ((G0Visitor<? extends T>)visitor).visitC(this);
	...
	public static class PContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof G0Listener ) ((G0Listener)listener).enterP(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof G0Listener ) ((G0Listener)listener).exitP(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof G0Visitor ) return ((G0Visitor<? extends T>)visitor).visitP(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class XContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof G0Listener ) ((G0Listener)listener).enterX(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof G0Listener ) ((G0Listener)listener).exitX(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof G0Visitor ) return ((G0Visitor<? extends T>)visitor).visitX(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class YContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof G0Listener ) ((G0Listener)listener).enterY(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof G0Listener ) ((G0Listener)listener).exitY(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof G0Visitor ) return ((G0Visitor<? extends T>)visitor).visitY(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof G0Listener ) ((G0Listener)listener).enterI(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof G0Listener ) ((G0Listener)listener).exitI(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof G0Visitor ) return ((G0Visitor<? extends T>)visitor).visitI(this);
			else return visitor.visitChildren(this);
		}
	}
