...
public class State {
	...
	static {
		...
		State lala3 = new State(3, false);
		State lala4 = new State(4, true);
		State lala5 = new State(5, false);
		State lala6 = new State(6, false);
		...
		lala2.addNext(' ', lala2);
		lala2.addNext('L', lala3);
		lala3.addNext('a', lala4);
		lala4.addNext('a', lala4);
		lala4.addNext(' ', lala4);
		lala4.addNext('L', lala5);
		lala5.addNext('a', lala6);
		lala6.addNext('a', lala6);
		lala6.addNext(' ', lala6);
		lala6.addNext('L', lala7);
		lala7.addNext('i', lala8);
		lala8.addNext(' ', lala8);
	}
}
